...
const HALAL_DATA = [
    {
      ...
      sources: [{ title: "Quran 5:96", author: "Surah Al-Ma'idah" }],
    ...
    },
    {
      ...
      sources: [{ title: "Quran 5:5", author: "Surah Al-Ma'idah" }], differingOpinions: null, isNew: false
    },
    {
    ...
    },
    {
      ...
      sources: [{ title: "Quran 2:168", author: "Halalan Tayyiban" }], differingOpinions: null, isNew: false
    }
  ];
  ...
  const MAKRUH_DATA = [
    ...
    },
    {
      ...
      sources: [{ title: "Quran 5:5 Context", author: "Tafsir Ibn Kathir" }], differingOpinions: "The debate centers on whether modern secular slaughterhouses qualify as 'People of the Book'.", isNew: false
    },
    {
  ...
  const HARAM_DATA = [
    {
      ...
      sources: [{ title: "Quran 2:275", author: "Surah Al-Baqarah" }], differingOpinions: null, isNew: false
    },
    {
      ...
      schoolsOfThought: [{ school: "Absolute Consensus", ruling: "Haram" }],
      sources: [{ title: "Quran 5:3", author: "Surah Al-Ma'idah" }], differingOpinions: null, isNew: false
    },
    {
      ...
      schoolsOfThought: [{ school: "Absolute Consensus", ruling: "Haram" }],
      sources: [{ title: "Quran 5:90", author: "Surah Al-Ma'idah" }], differingOpinions: null, isNew: false
    },
    {
  ...
  export const MARRIAGE_DATA = {
    husband: [
      ...
      { 
        ...
        sources: [{ title: "Riyad as-Salihin", author: "Imam Nawawi" }]
      },
      { 
    ...
    wife: [
      ...
      { 
        ...
        sources: [{ title: "Tafsir Ibn Kathir", author: "Ibn Kathir" }]
      },
      { 
        title: "Consultation", 
    ...
    shared: [
      { 
        ...
        sources: [{ title: "Quran 4:12", author: "Surah An-Nisa" }]
      },
      { 
  ...
  export const CONTROVERSIES_DATA = [
    ...
    },
    {
      ...
      sources: [{ title: "War and Peace in Islam", author: "Dr. Mustafa Abu Sway" }]
    },
    {
      ...
      sources: [{ title: "Tafsir Al-Razi", author: "Fakhr al-Din al-Razi" }]
    },
    {
      topic: "Gender Roles",
      ...
      sources: [{ title: "Women in Islamic Law", author: "Dr. Jamal Badawi" }]
    }
  ];