                    ...
                    <div className="flex flex-wrap gap-3">
                      {item.sources.map((s, i) => (
                        ...
                        >
                          ...
                          <div>
                            <span className={`block font-bold text-xs uppercase tracking-wider transition-colors ${s.link ? 'text-white group-hover:text-[#ccff00]' : 'text-zinc-500'}`}>{s.title}</span>
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-3 border-b border-zinc-800 pb-3">
                              ...
                              {scholar.source && (
                                <button 
                                  ...
                                  className={`inline-flex items-center gap-2 px-3 py-1.5 bg-[#050505] border border-zinc-700 text-[9px] font-mono uppercase tracking-widest transition-colors ${scholar.source.link ? 'text-zinc-500 hover:border-[#ccff00] hover:text-[#ccff00] cursor-pointer' : 'text-zinc-600 cursor-default'}`}
                                >
