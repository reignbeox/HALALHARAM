        ...
        <div className="max-w-7xl mx-auto">
          {!activeItem ? (
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              <button onClick={() => navigateTo('directory')} className="mb-8 flex items-center gap-3 px-4 py-2 bg-zinc-900 border border-zinc-700 text-zinc-500 hover:text-black hover:bg-[#ccff00] hover:border-[#ccff00] font-mono text-[10px] font-bold uppercase tracking-[0.2em] transition-all w-fit">
