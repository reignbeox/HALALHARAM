...
export default function MethodologyView({ navigateTo }) {
  return (
    <section className="methodology-section px-6 py-16 relative z-10 bg-[#0a0a0a] flex-grow">
      <div className="max-w-4xl mx-auto">
        <div className="mb-12">
          <h2 className="section-title text-4xl md:text-6xl font-black text-white uppercase tracking-tighter mb-4">THE METHODOLOGY</h2>
        </div>

        <div className="space-y-12">
          {/* 01 Source Hierarchy */}
          <div className="relative pl-12 border-l-2 border-zinc-800 divider-line">
            ...
            <h3 className="text-xl font-black text-white uppercase mb-4 flex items-center gap-3 section-title">
              <BookOpen className="w-5 h-5 text-[#ccff00]" /> SOURCE HIERARCHY
            </h3>
            <p className="font-mono text-zinc-400 text-sm leading-relaxed uppercase mb-4 body-text">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {['The Quran', 'Authentic Sunnah (Hadith)', 'Ijma (Scholarly Consensus)', 'Qiyas (Analogical Reasoning)'].map((step, i) => (
                <li key={i} className="hierarchy-item bg-zinc-900 p-3 border border-zinc-800 font-mono text-[10px] text-white font-bold tracking-widest">
                  &gt; {step}
                </li>
              ))}
            </ul>
